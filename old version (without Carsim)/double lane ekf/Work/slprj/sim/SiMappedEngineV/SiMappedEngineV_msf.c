...
static void mdlInitializeConditions ( SimStruct * S ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; fpgmc1blog * localX = ( fpgmc1blog * )
ssGetContStates ( S ) ; f5rmroe5ej ( localX ) ; ssSetPeriodicContState ( S ,
0 , 3 , 0 , 720 ) ; } static void mdlReset ( SimStruct * S ) { o2k4rz0uw5x *
dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; fpgmc1blog * localX = (
fpgmc1blog * ) ssGetContStates ( S ) ; f4glzcjee3 ( localX ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T * o_o_B_2_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; fpgmc1blog * localX = ( fpgmc1blog * )
ssGetContStates ( S ) ; real_T const * i_i_i_plq14ufrxm = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; if ( tid == 0 ) { SiMappedEngineV (
o_o_B_2_1 , & ( dw -> rtb ) , localX ) ; pj3vtlmlns ( & ( dw -> rtm ) ,
i_i_i_plq14ufrxm , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void
...
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; pj3vtlmlns ( & ( dw -> rtm ) ,
i_i_i_plq14ufrxm , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; jgubm4xidl * localZCSV = (
jgubm4xidl * ) ssGetNonsampledZCs ( S ) ; a20sjwaowh ( & ( dw -> rtm ) ,
i_i_i_plq14ufrxm , & ( dw -> rtb ) , & ( dw -> rtdw ) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T const * i_ec0csx13uo = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_i_i_plq14ufrxm = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T * o_o_B_2_1 = ( real_T * )
...
) ; } static void mdlTerminate ( SimStruct * S ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; po5zlrzzyd ( & ( dw -> rtm ) ) ;
return ; }
...
mr_SiMappedEngineV_GetDWork ( ssGetDWork ( S , 0 ) ) ; mxSetFieldByNumber (
