...
- 1 , 0 } } ; static int_T rt_LoggedStateIdxList [ ] = { 8 , 6 , 3 , 5 , 1 ,
2 , 4 , 7 , 11 , 9 , 10 , 0 } ;
...
int8_T ) 0 , ( uint8_T ) 0 } } ; static int_T rtContextSystems [ 8 ] ; static
rtwCAPI_LoggingMetaInfo loggingMetaInfo [ ] = { { 0 , 0 , "" , 0 } } ; static
rtwCAPI_ModelMapLoggingStaticInfo mmiStaticInfoLogging = { 8 ,
rtContextSystems , loggingMetaInfo , 0 , ( NULL ) , { 0 , ( NULL ) , ( NULL )
} , 0 , ( NULL ) } ; static rtwCAPI_ModelMappingStaticInfo mmiStatic = { {
rtBlockSignals , 0 , ( NULL ) , 0 , ( NULL ) , 0 } , { ( NULL ) , 0 , ( NULL
) , 0 } , { rtBlockStates , 12 } , { rtDataTypeMap , rtDimensionMap ,
rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float" ,
{ 2931746222U , 1473836046U , 904082322U , 2868477327U } , &
